...
public class ReservationServiceConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Reservation r2 = new Reservation(c2, e2); 
		rs.addReservation(r2); 
		Reservation r3 = new Reservation(c3, e3); 
		rs.addReservation(r3); 
		Reservation r4 = new Reservation(c4, e11); 
		rs.addReservation(r4);
		Reservation r5 = new Reservation(c5, e12); 
		rs.addReservation(r5);
		Reservation r6 = new Reservation(c6, e9); 
		rs.addReservation(r6);
		Reservation r7 = new Reservation(c7, e6); 
		rs.addReservation(r7);
		Reservation r8 = new Reservation(c8, e3); 
		rs.addReservation(r8);
		Reservation r9 = new Reservation(c9, e15); 
		rs.addReservation(r9);
		Reservation r10 = new Reservation(c10, e14); 
		rs.addReservation(r10);
		Reservation r11 = new Reservation(c4, e9); 
		rs.addReservation(r11);
		Reservation r12 = new Reservation(c8, e12); 

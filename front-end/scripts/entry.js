...
function checkDates(dateFly, dateRet){
    ...
    var today = new Date();
    var formattedToday = new Date(today.toISOString().split('T')[0]);

    console.log(formattedToday);
    if(date2 > date1 && date1 > formattedToday ){
        return true;
    }
...
function registerExcursion(){
    ...
    const depLocation = document.getElementById("depLocation").value.toUpperCase();
